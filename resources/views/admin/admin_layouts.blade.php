...
<html lang="en">
  <head>
    ...
    <meta name="twitter:title" content="eTechHouse">
    <meta name="twitter:description" content="Premium Quality and Responsive UI for Dashboard.">
    <meta name="twitter:image" content="http://themepixels.me/starlight/img/starlight-social.png">

    <!-- Facebook -->
    <meta property="og:url" content="http://themepixels.me/starlight">
    <meta property="og:title" content="eTechHouse">
...
<!-- Datatable css -->
  ...
  <body>
     ...
     @else
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> eTechHouse</a></div>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{ asset('public/backend/img/img3.png') }} " class="wd-32 rounded-circle" alt="">
            </a>
      ...
      <div class="tab-content">
        <div class="tab-pane pos-absolute a-0 mg-t-60 active" id="messages" role="tabpanel">
          <div class="media-list">
            ...
            <a href="" class="media-list-link">
              <div class="media">
                <img src="../img/img3.png" class="wd-40 rounded-circle" alt="">
            ...
            <a href="" class="media-list-link">
              <div class="media">
                <img src="../img/img4.png" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="notifications" role="tabpanel">
          <div class="media-list">
            ...
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                <img src="../img/img10.png" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
