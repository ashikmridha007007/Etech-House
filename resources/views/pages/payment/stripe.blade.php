...
<div class="contact_form">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 me-5" style="border: 1px solid grey; padding: 20px; border-radius: 25px;">
      ...
      <div class="col-lg-5" style="margin-left:20px; border: 1px solid grey; padding: 20px; border-radius: 25px;">
        <div class="contact_form_container">
...
<script type="text/javascript">
  ...
  var stripe = Stripe('pk_test_51K9yXaE8JXW6tIWCkdsVjV2EfPvd5YLORUhxLPTbQBehePZXxTus9nyiLvzSMOlwsoE6MXz8DsIjiNd6xtQnSij300uCZgMIDi');
